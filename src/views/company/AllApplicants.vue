...
<div class="all-applicants">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="#" @click="exportData('csv')">Export as CSV</a></li>
          <li><a class="dropdown-item" href="#" @click="exportData('excel')">Export as Excel</a></li>
          <li><a class="dropdown-item" href="#" @click="exportData('pdf')">Export as PDF</a></li>
        </ul>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-3">
          <div class="btn-group w-100" role="group">
            <button 
              type="button" 
              class="btn"
              :class="currentView === 'table' ? 'btn-primary' : 'btn-outline-secondary'"
            ...
            <button 
              type="button" 
              class="btn"
              :class="currentView === 'pipeline' ? 'btn-primary' : 'btn-outline-secondary'"
  ...
  <div class="content-area">
    ...
    <!-- Pipeline View -->
    <div v-else-if="currentView === 'pipeline'">
      <ApplicantsPipeline 
        :view-mode="currentView"
        @switch-view="switchView"
      />
  ...
  <div v-if="showApplicantDetails" class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0,0,0,0.5);">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Applicant Details</h5>
          <button type="button" class="btn-close" @click="closeApplicantDetails"></button>
        </div>
        <div class="modal-body">
          <ApplicantDetails 
            v-if="selectedApplicantId"
            :applicant-id="selectedApplicantId"
            @close="closeApplicantDetails"
          />
        </div>
      </div>
    </div>
