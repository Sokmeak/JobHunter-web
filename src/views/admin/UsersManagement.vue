            ...
            <tr v-for="user in filteredUsers" :key="user.id" class="user-row">
              ...
              <td class="verified-cell">
                <div class="verified-status" :class="{ verified: user.verified }">
                  <component :is="user.verified ? CheckCircle : XCircle" class="verified-icon" />
              ...
              <td class="actions-cell">
                <div class="actions-dropdown" @click="toggleActionsMenu(user.id)">
                  ...
                  <div v-if="activeActionsMenu === user.id" class="actions-menu">
                    ...
                    <button @click="toggleVerification(user.id)" class="action-item">
                      <component :is="user.verified ? XCircle : CheckCircle" class="action-icon" />
                      <span>{{ user.verified ? 'Unverify' : 'Verify' }}</span>
                    </button>
                    <button @click="suspendUser(user.id)" class="action-item danger">
                      <Ban class="action-icon" />
                      <span>Suspend</span>
                    </button>
                    <button @click="deleteUser(user.id)" class="action-item danger">
