      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div class="btn-group" role="group">
            ...
            <button type="button" class="btn btn-primary">Table View</button>
          </div>
        </div>
      </div>
      ...
      <div class="card border-0 shadow-sm">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        <a
                          class="dropdown-item"
                          href="#"
                          @click="moveToShortlist(applicant.id)"
                          >Move to Shortlist</a
                        >
                      </li>
        ...
        >
          <div class="text-muted small">
            Showing
            {{
              Math.min((currentPage - 1) * itemsPerPage + 1, totalApplicants)
            }}
            to {{ Math.min(currentPage * itemsPerPage, totalApplicants) }} of
...
const totalPages = computed(() =>
  Math.ceil(totalApplicants.value / itemsPerPage.value)
);
