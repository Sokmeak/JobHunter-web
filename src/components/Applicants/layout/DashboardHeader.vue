<template>
  <header class="dashboard-header d-flex align-items-center justify-content-between p-3">
...
export default {
  ...
  mounted() {
    console.log('DashboardHeader mounted, showBackButton:', this.showBackButton);
  },
  watch: {
